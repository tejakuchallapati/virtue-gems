...
export const PAGE_GRADIENT_SHELL =
  "min-h-dvh w-full max-w-full overflow-x-clip bg-gradient-to-b from-[#faf6ee] via-light to-white";
...
export const EMPTY_STATE_SHELL =
  "mx-auto max-w-lg px-4 py-14 pb-[calc(3.5rem+var(--mobile-nav-offset))] text-center sm:py-24 sm:pb-24";
